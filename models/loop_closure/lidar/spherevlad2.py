...
from ..transformer.attention import Spatial_Attn


class SphereVLAD2(nn.Module):
    '''
    sphvlad2 with bn
    '''
    def __init__(self, config):
        super(SphereVLAD2, self).__init__()
        ...
        self.attention = Spatial_Attn(in_dim=config.MODEL.NETVLAD.FEATURE_DIM)
    ...
    def forward(self, x):
        ...
        x = self.conv3(x)
        x = self.conv4(x)
        # reshape and normalize across the descriptor dimension
